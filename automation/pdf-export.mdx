...
description: "Export any Oviond report as a PDF on demand or deliver PDFs automatically via automations. Configure page size, orientation, cover page, and page numbering."
---
...
To send PDFs on a recurring schedule, create an automation and select **PDF attachment** as the delivery method. See [Scheduled Reports](/automation/scheduled-reports) for the full setup steps.
