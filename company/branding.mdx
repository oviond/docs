---
title: "Branding"
description: "Upload the logos your reports and shared links use."
---
...
Each client has its own **Branding defaults**, found in that client's settings. Here you choose the **Logo source** for the client's reports and shared links.
