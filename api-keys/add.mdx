---
title: "Add API key"
description: "Create an API key to authenticate REST API and MCP calls."
---

API keys let external scripts, integrations, and AI connectors call the Oviond API on behalf of your account. You choose a permission level for each key when you create it, so a key can be scoped more tightly than your own account.
