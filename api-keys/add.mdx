...
<Steps>
  ...
  <Step title="Choose a permission">
    ...
    |---|---|
    | **View** | Read-only access. View clients, reports, and data, but can't make changes. |
    | **Edit** | Read and write content. Create and edit clients, reports, and data — but not account settings, billing, or team. |
