...
1. [Connect a Data Source](/data-sources/client-sources) — the client's card on the Clients list offers **Connect a data source** until one is linked
2. [Create your first Report](/reports/list) — a Multi-Page Report or Dashboard
