...
Open an automation and click **Executions** (or open the report's run history) to see every past run — scheduled and test — with its timestamp and status. See [Run history](/automations/history).
