...
description: "Connect your clients' marketing platforms to Oviond. Browse supported integrations including Google Ads, Facebook Ads, Google Analytics, and 30+ more."
---
...
Oviond will attempt to fetch data from the platform and confirm whether the connection is active. If the test fails, see [Connect a Data Source to a Client](/integrations/connecting-data-sources) for troubleshooting steps.
...
<CardGroup cols={2}>
  <Card title="Connect a data source" icon="plug" href="/integrations/connecting-data-sources">
    Step-by-step guide to authorizing a platform and linking it to a client.
  </Card>
  <Card title="Custom metrics and data" icon="sliders" href="/integrations/metrics">
