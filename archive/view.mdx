...
The Archive lists archived items by type:

- **Clients**
- **Reports** (multi-page reports and dashboards)
- **Media** (images and files)
- **Automations**
- **Templates**
- **Goals**, **Calculated Metrics**, **Saved Metrics**
- **Custom Data**, **Assets**, **Themes**
- **Exports**, **Notifications**

<Note>
Over the API and MCP, the archive type for a report is still the stored value `projects`. Only the label changed with the rename.
</Note>
