---
title: "Share Report"
description: "Publish a report via a shareable public link."
---

Share a report with a client, stakeholder, or prospect via a public URL. The recipient opens the link in any browser — **no Oviond account required** — and sees the report with live data.

<Steps>
  <Step title="Open the report">
    From the client's **Reports** tab, click the report.
  </Step>
...
- **Download** — generate a PDF (available when **Allow PDF Download** is on). Multi-Page Reports only; dashboards have no pages to paginate, so the tab and the toggle don't appear.
