...
<Steps>
  ...
  <Step title="Connect a data source">
    Open a project, then go to the **Data sources** tab in the project editor sidebar. Search for a platform (for example, Google Ads or Facebook Ads) and select it to start the connection wizard. Connect with OAuth or an API key, depending on the platform.
