...
<Steps>
  ...
  <Step title="Change the tokens">
    Update any of: name, **Primary colour**, **Palette mode** and individual chart colours, canvas colours, **Header background**, **Radius**, **Shadow**, and **Font**. You can also edit the cover-page and thank-you-page designs.
  </Step>
  <Step title="Preview">
