...
| `query_data` | Pull live metric values from a client's connected datasource for any date range, without touching a report. Nothing is saved — use this for ad-hoc analysis and period comparisons. To read the numbers a report already holds, use get_widget_data instead… |
