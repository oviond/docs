...
The MCP server exposes **188 tools** covering most of the Oviond surface area:

- **Clients & folders** — create, rename, delete, move, and organize clients.
- **Reports & pages** — create reports and dashboards, add and reorder pages, duplicate layouts, change the period a report covers.
- **Widgets** — add, update, move, and remove every widget type: text, title, image, embed, button, data, calculated metric, custom data, goal, and static value.
...
- **Templates & themes** — browse the template library, apply themes to reports.
